        ...
        <div className={s.addRecipe}>
            <form onSubmit={handleSubmit} id={s.addForm}>
                ...
                <div className={s.buttonsContainer}>
                    <button className={s.addButton} type="submit" disabled={recipe.name && recipe.summary ? false : true} >Create recipe</button>
                ...
                {result && Array.isArray(result) ?
                    <div><img className={s.crossImg} src={cross} alt="" width="80" height="80" /><h4 className={s.help}>{result[0]}</h4>
